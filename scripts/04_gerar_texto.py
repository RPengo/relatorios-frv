...
def montar_prompt(dados_relatorio: dict[str, Any], classificacao: dict[str, Any], trechos_base: str) -> str:
    instrucoes = (
        ...
        "Sempre que os dados permitirem, calcular dinamicamente ganhos numéricos vs controle em sc ha⁻¹; "
        "evitar expressar diferença numérica de produtividade em kg ha⁻¹. "
        ...
        "Para resultados sem significância, prefira a formulação: "
        "'esse comportamento indica tendência numérica de resposta, sem confirmação estatística nas condições avaliadas'. "
        "Evite a frase 'potencial efeito positivo do produto' quando não houver significância. "
